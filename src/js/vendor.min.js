        ...
        if ((t && typeof t == 'object') || typeof t == 'function')
            for (let n of Ci(t))
                !Mi.call(e, n) &&
                    ...
                    Ce(e, n, {
                        get: () => t[n],
                        enumerable: !(i = Li(t, n)) || i.enumerable,
                    });
        return e;
    };
var $i = (e, t, r) => (
...
var Rr = ki(() => {
    (function () {
        ...
        var e = function (h, c) {
            var p = function (N) {
                    for (var x = 0, A = N.length; x < A; x++) w(N[x]);
                },
                w = function (N) {
                    var x = N.target,
                        A = N.attributeName,
                        K = N.oldValue;
                    x.attributeChangedCallback(A, K, x.getAttribute(A));
                };
            return function (E, N) {
                var x = E.constructor.observedAttributes;
                return (
                    x &&
                        h(N).then(function () {
                            new c(p).observe(E, {
        ...
        function t(h, c) {
            if (h) {
                if (typeof h == 'string') return r(h, c);
        ...
        function r(h, c) {
            ...
            for (var p = 0, w = new Array(c); p < c; p++) w[p] = h[p];
            return w;
        }
        function i(h, c) {
            var p =
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        var n = !0,
                ...
                var p =
                    ...
                    E =
                        arguments.length > 3 && arguments[3] !== void 0
                            ? arguments[3]
                            : ['*'],
                    N = function K(pt, mt, tt, O, j, U) {
                        var et = i(pt),
                            Dt;
                        try {
                            for (et.s(); !(Dt = et.n()).done; ) {
                                var Y = Dt.value;
                                (U || o in Y) &&
                                    (j
                                        ? tt.has(Y) ||
                                          (tt.add(Y), O.delete(Y), c(Y, j))
                                        : O.has(Y) ||
                                          (O.add(Y), tt.delete(Y), c(Y, j)),
                                    U || K(Y[o](mt), mt, tt, O, j, n));
                            }
                        } catch (Le) {
                            et.e(Le);
                        } finally {
                    ...
                    A = x.observe;
                return (
                    (x.observe = function (K) {
                        return A.call(x, K, { subtree: n, childList: n });
                    })(p),
                    x
                );
            },
            ...
            R = function (h) {
                var c = new I(),
                    p = function (O) {
                        for (var j = 0, U = O.length; j < U; j++)
                            c.delete(O[j]);
                    },
                    w = function () {
                        for (
                            var O = pt.takeRecords(), j = 0, U = O.length;
                            j < U;
                            j++
                        )
                            x(k.call(O[j].removedNodes, M), !1),
                                x(k.call(O[j].addedNodes, M), !0);
                    },
                    E = function (O) {
                        return (
                            O.matches ||
                    ...
                    N = function (O, j) {
                        ...
                        if (j)
                            for (
                                var et, Dt = E(O), Y = 0, Le = A.length;
                                Y < Le;
                                Y++
                            )
                                Dt.call(O, (et = A[Y])) &&
                                    (c.has(O) || c.set(O, new L()),
                                    (U = c.get(O)),
                                    U.has(et) ||
                                        (U.add(et), h.handle(O, j, et)));
                        else
                            c.has(O) &&
                                ((U = c.get(O)),
                                c.delete(O),
                    ...
                    K = h.root || y,
                    pt = u(N, K, m, A),
                    mt = g.prototype.attachShadow;
                return (
                    mt &&
                        (g.prototype.attachShadow = function (tt) {
                            var O = mt.call(this, tt);
                            return pt.observe(O), O;
                        }),
                    A.length && x(K[d](A)),
                    { drop: p, flush: w, observer: pt, parse: x }
                );
            },
            P = self,
            F = P.document,
            ...
            C = B.setPrototypeOf,
            W = !self.customElements,
            H = function (c) {
                for (
                    var p = T(c), w = [], E = new X(), N = p.length, x = 0;
                    x < N;
                    x++
                ) {
                    w[x] = c[p[x]];
                ...
                return function () {
                    for (var A = 0; A < N; A++) E.has(A) || (c[p[A]] = w[A]);
                };
            };
        if (W) {
            var nt = function () {
                    var c = this.constructor;
                    if (!rt.has(c)) throw new a('Illegal constructor');
                    var p = rt.get(c);
                    if (Qt) return ir(Qt, p);
                    var w = ht.call(F, p);
                    return ir(C(w, c.prototype), p);
                },
                ht = F.createElement,
                rt = new z(),
                st = new z(),
                ...
                gi = function (c, p, w) {
                    ...
                    var x = ''.concat(p ? '' : 'dis', 'connectedCallback');
                    x in E && c[x]();
                },
                yi = R({ query: Nt, handle: gi }),
                bi = yi.parse,
                Qt = null,
                _e = function (c) {
                    if (!st.has(c)) {
            ...
            (self.customElements = {
                define: function (c, p) {
                    ...
                    rt.set(p, c),
                        Lt.set(c, p.prototype),
                        ct.set(c, p),
                        Nt.push(c),
                        _e(c).then(function () {
                            bi(F.querySelectorAll(c));
                        }),
                        st.get(c)._(p);
                },
                get: function (c) {
                ...
                S((nt.prototype = J.prototype), 'constructor', { value: nt }),
                (self.HTMLElement = nt),
                (F.createElement = function (h, c) {
                    var p = c && c.is,
                        w = p ? ct.get(p) : ct.get(h);
                    return w ? new w() : ht.call(F, h);
                }),
                'isConnected' in b.prototype ||
                    S(b.prototype, 'isConnected', {
                        configurable: !0,
                        get: function () {
                            return !(
        ...
        } else if (((W = !self.customElements.get('extends-br')), W))
            try {
                var nr = function h() {
                ...
                var or = 'extends-br';
                self.customElements.define('extends-br', nr, { extends: 'br' }),
                    (W =
                        F.createElement('br', { is: or }).outerHTML.indexOf(
                            or
                        ) < 0);
                var sr = self.customElements,
                    wi = sr.get,
                    Ei = sr.whenDefined;
                self.customElements.whenDefined = function (h) {
                    var c = this;
                    return Ei.call(this, h).then(function (p) {
                        return p || wi.call(c, h);
                    });
                };
            } catch {}
        if (W) {
            var ar = function (c) {
                    var p = Ne.get(c);
                    dr(p.querySelectorAll(this), c.isConnected);
                },
                ...
                _i = R({ query: re, handle: Ii }),
                dr = _i.parse,
                Ni = R({
                    query: ur,
                    handle: function (c, p) {
                        Ne.has(c) &&
                            (p ? De.add(c) : De.delete(c),
                            re.length && ar.call(re, c));
                    },
                }),
                Di = Ni.parse,
                hr = _.prototype.attachShadow;
            hr &&
                (_.prototype.attachShadow = function (h) {
                    var c = hr.call(this, h);
                    return Ne.set(this, c), c;
                });
            var Pe = function (c) {
                    if (!te.has(c)) {
                        var p,
            ...
            D(self)
                ...
                .forEach(function (h) {
                    ...
                    function p() {
                        ...
                        if (!Jt.has(w)) throw new a('Illegal constructor');
                        var E = Jt.get(w),
                            N = E.is,
                            x = E.tag;
                        if (N) {
                            if (ie) return Fe(ie, N);
                            var A = lr.call(F, x);
                            return (
                                A.setAttribute('is', N),
                                Fe(C(A, w.prototype), N)
                            );
                        } else return Ai.call(this, c, [], w);
                    }
                    S((p.prototype = c.prototype), 'constructor', { value: p }),
                        S(self, h, { value: p });
                }),
                (F.createElement = function (h, c) {
                    var p = c && c.is;
                    if (p) {
                        var w = ee.get(p);
                        if (w && Jt.get(w).tag === h) return new w();
                    }
                    var E = lr.call(F, h);
                    return p && E.setAttribute('is', p), E;
                }),
                (at.get = fr),
                (at.whenDefined = Pe),
                (at.upgrade = function (h) {
                    var c = h.getAttribute('is');
                    if (c) {
                        var p = ee.get(c);
                        if (p) {
                            Fe(C(h, p.prototype), c);
                            return;
                        }
                    }
                    Oi.call(at, h);
                }),
                (at.define = function (h, c, p) {
                    if (fr(h))
                        throw new l(
                            "'".concat(
                                h,
                    ...
                    var w,
                        E = p && p.extends;
                    Jt.set(c, E ? { is: h, tag: E } : { is: '', tag: h }),
                        E
                            ? ((w = ''.concat(E, '[is="').concat(h, '"]')),
                              cr.set(w, c.prototype),
                              ee.set(h, c),
                              re.push(w))
                            : (xi.apply(at, arguments), ur.push((w = h))),
                        Pe(h).then(function () {
                            E
                                ? (dr(F.querySelectorAll(w)),
                                  De.forEach(ar, [w]))
                                : Di(F.querySelectorAll(w));
                        }),
                        te.get(h)._(c);
                });
        }
...
function Wi() {
    ...
    if (
        (r > -1 && (ne = parseInt(navigator.userAgent.substring(r + 7))),
        t && ne && ne < 110)
    )
        return;
    ...
    if ('instantIntensity' in document.body.dataset) {
        ...
        if (d.startsWith('mousedown'))
            (s = !0), d == 'mousedown-only' && (o = !0);
        else if (d.startsWith('viewport')) {
            let f = navigator.connection && navigator.connection.saveData,
                y =
    ...
    if (
        ...
        s
            ? i || document.addEventListener('mousedown', Hi, n)
            : document.addEventListener('mouseover', Bi, n),
        i && document.addEventListener('mousedown', Ui, n),
        u)
    ) {
...
function Bi(e) {
    if (performance.now() - Re < br || !('closest' in e.target)) return;
    let t = e.target.closest('a');
    oe(t) &&
        (t.addEventListener('mouseout', Ki, { passive: !0 }),
        (Ct = setTimeout(() => {
            se(t.href, 'high'), (Ct = void 0);
        }, yr)));
}
function Hi(e) {
    let t = e.target.closest('a');
...
function Ki(e) {
    (e.relatedTarget &&
        ...
        (Ct && (clearTimeout(Ct), (Ct = void 0)));
}
function Ui(e) {
    if (performance.now() - Re < br) return;
    let t = e.target.closest('a');
...
var Er = [
    ...
    Sr = function (t, r, i) {
        if (ce(t)) return [];
        var n = Array.prototype.slice.apply(t.querySelectorAll(ae));
        return r && St.call(t, ae) && n.unshift(t), (n = n.filter(i)), n;
    },
    Or = function e(t, r, i) {
        for (var n = [], s = Array.from(t); s.length; ) {
            ...
            if (!ce(o, !1))
                if (o.tagName === 'SLOT') {
                    ...
                    if (g && m) {
                        var L = e(g === !0 ? o.children : g.children, !0, i);
                        i.flatten
                            ? n.push.apply(n, L)
    ...
    vt = function (t) {
        ...
        return t.tabIndex < 0 &&
            (/^(AUDIO|VIDEO|DETAILS)$/.test(t.tagName) || qi(t)) &&
            !Tr(t)
            ? 0
            : t.tabIndex;
    },
    ...
    nn = function (t, r) {
        ...
        var s = St.call(t, 'details>summary:first-of-type'),
            o = s ? t.parentElement : t;
        if (St.call(o, 'details:not([open]) *')) return !0;
        if (!i || i === 'full' || i === 'legacy-full') {
            if (typeof n == 'function') {
                for (var u = t; t; ) {
                    var d = t.parentElement,
                        f = le(t);
                    if (d && !d.shadowRoot && n(d) === !0) return wr(t);
                    t.assignedSlot
                        ? (t = t.assignedSlot)
                        : !d && f !== t.ownerDocument
                        ? (t = f.host)
            ...
            if (rn(t)) return !t.getClientRects().length;
            ...
            for (var r = t.parentElement; r; ) {
                if (r.tagName === 'FIELDSET' && r.disabled) {
                    for (var i = 0; i < r.children.length; i++) {
                        ...
                        if (n.tagName === 'LEGEND')
                            return St.call(r, 'fieldset[disabled] *')
                                ? !0
                                : !n.contains(t);
                    }
                    return !0;
    ...
    ue = function (t, r) {
        return !(r.disabled || ce(r) || Xi(r) || nn(r, t) || Yi(r) || on(r));
    },
    Me = function (t, r) {
        return !(en(r) || vt(r) < 0 || !ue(t, r));
    },
    sn = function (t) {
    ...
    Ir = function (t, r) {
        ...
        return (
            r.getShadowRoot
                ...
                : (i = Sr(t, r.includeContainer, Me.bind(null, r))),
            an(i)
        );
    },
    _r = function (t, r) {
        ...
        return (
            r.getShadowRoot
                ? (i = Or([t], r.includeContainer, {
                      filter: ue.bind(null, r),
                      flatten: !0,
                      getShadowRoot: r.getShadowRoot,
                  }))
                : (i = Sr(t, r.includeContainer, ue.bind(null, r))),
            i
        );
    },
    Ot = function (t, r) {
        if (((r = r || {}), !t)) throw new Error('No node provided');
        return St.call(t, ae) === !1 ? !1 : Me(r, t);
    },
    ln = Er.concat('iframe').join(','),
    fe = function (t, r) {
        if (((r = r || {}), !t)) throw new Error('No node provided');
        return St.call(t, ln) === !1 ? !1 : ue(r, t);
    };
function Nr(e, t) {
    var r = Object.keys(e);
...
function Dr(e) {
    for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2
            ? Nr(Object(r), !0).forEach(function (i) {
                  cn(e, i, r[i]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
            : Nr(Object(r)).forEach(function (i) {
    ...
    gn = function (t, r) {
        var i = r?.document || document,
            ...
            y = function (l) {
                ...
                var D = a;
                if (typeof a == 'string' && ((D = i.querySelector(a)), !D))
                    throw new Error(
            ...
            g = function () {
                var l = y('initialFocus');
                if (l === !1) return !1;
                if (l === void 0 || !fe(l, s.tabbableOptions))
                    if (f(i.activeElement) >= 0) l = i.activeElement;
                    else {
                        var a = o.tabbableGroups[0],
                            v = a && a.firstTabbableNode;
                        l = v || y('fallbackFocus');
                    }
                if (!l)
                    throw new Error(
            ...
            m = function () {
                if (
                    ((o.containerGroups = o.containers.map(function (l) {
                        var a = Ir(l, s.tabbableOptions),
                            v = _r(l, s.tabbableOptions),
                            S = a.length > 0 ? a[0] : void 0,
                            T = a.length > 0 ? a[a.length - 1] : void 0,
                            D = v.find(function (H) {
                                return Ot(H);
                            }),
                            C = v
                        ...
                        return {
                            ...
                            nextTabbableNode: function (nt) {
                                ...
                                return rt < 0
                                    ? ht
                                        ? v
                                              .slice(v.indexOf(nt) + 1)
                                              .find(function (st) {
                                                  return Ot(st);
                                              })
                                        : v
                                              .slice(0, v.indexOf(nt))
                                              .reverse()
                                              .find(function (st) {
                                                  return Ot(st);
                                              })
            ...
            k = function (l) {
                ...
                if (o.tabbableGroups.length > 0) {
                    var C = f(a, v),
                        W = C >= 0 ? o.containerGroups[C] : void 0;
                    if (C < 0)
                        T
                            ? (D =
                                  o.tabbableGroups[o.tabbableGroups.length - 1]
                                      .lastTabbableNode)
                            : (D = o.tabbableGroups[0].firstTabbableNode);
                    else if (T) {
                        var H = Lr(o.tabbableGroups, function (ct) {
                            var Nt = ct.firstTabbableNode;
                            return a === Nt;
                        });
                        if (
                            (H < 0 &&
                                (W.container === a ||
                                    (fe(a, s.tabbableOptions) &&
                                        !Ot(a, s.tabbableOptions) &&
                                        !W.nextTabbableNode(a, !1))) &&
                                (H = C),
                            H >= 0)
                        ) {
                            var nt =
                                    H === 0
                                        ...
                                        : H - 1,
                                ht = o.tabbableGroups[nt];
                            D =
                                vt(a) >= 0
                                    ? ht.lastTabbableNode
                                    : ht.lastDomTabbableNode;
                        } else Mt(v) || (D = W.nextTabbableNode(a, !1));
                    } else {
                        var rt = Lr(o.tabbableGroups, function (ct) {
                            var Nt = ct.lastTabbableNode;
                            return a === Nt;
                        });
                        if (
                            (rt < 0 &&
                                (W.container === a ||
                                    (fe(a, s.tabbableOptions) &&
                                        !Ot(a, s.tabbableOptions) &&
                                        !W.nextTabbableNode(a))) &&
                                (rt = C),
                            rt >= 0)
                        ) {
                            var st =
                                    rt === o.tabbableGroups.length - 1
                                        ? 0
                                        : rt + 1,
                                Lt = o.tabbableGroups[st];
                            D =
                                vt(a) >= 0
                                    ? Lt.firstTabbableNode
                                    : Lt.firstDomTabbableNode;
                        } else Mt(v) || (D = W.nextTabbableNode(a));
                    }
                } else D = y('fallbackFocus');
                return D;
            },
            R = function (l) {
                var a = de(l);
                if (!(f(a, l) >= 0)) {
                    if (Rt(s.clickOutsideDeactivates, l)) {
                        u.deactivate({
                            returnFocus: s.returnFocusOnDeactivate,
                        });
                        return;
                    }
                    Rt(s.allowOutsideClick, l) || l.preventDefault();
                }
            },
            P = function (l) {
                var a = de(l),
                    v = f(a, l) >= 0;
                if (v || a instanceof Document)
                    v && (o.mostRecentlyFocusedNode = a);
                else {
                    l.stopImmediatePropagation();
                    var S,
                        T = !0;
                    if (o.mostRecentlyFocusedNode)
                        if (vt(o.mostRecentlyFocusedNode) > 0) {
                            var D = f(o.mostRecentlyFocusedNode),
                                C = o.containerGroups[D].tabbableNodes;
                            if (C.length > 0) {
                                var W = C.findIndex(function (H) {
                            ...
                            o.containerGroups.some(function (H) {
                                return H.tabbableNodes.some(function (nt) {
                                    return vt(nt) > 0;
                                });
                            }) || (T = !1);
                    else T = !1;
                    T &&
                        ...
                        I(S || o.mostRecentlyFocusedNode || g());
                }
            ...
            F = function (l) {
                var a =
                    arguments.length > 1 && arguments[1] !== void 0
                        ...
                        : !1;
                o.recentNavEvent = l;
                var v = k({ event: l, isBackward: a });
                v && (Mt(l) && l.preventDefault(), I(v));
            },
            z = function (l) {
                if (hn(l) && Rt(s.escapeDeactivates, l) !== !1) {
                    l.preventDefault(), u.deactivate();
                    return;
                }
                (s.isKeyForward(l) || s.isKeyBackward(l)) &&
                    F(l, s.isKeyBackward(l));
            },
            $ = function (l) {
                var a = de(l);
                f(a, l) >= 0 ||
                    Rt(s.clickOutsideDeactivates, l) ||
                    Rt(s.allowOutsideClick, l) ||
            ...
            X = function () {
                if (o.active)
                    return (
                        ...
                        i.removeEventListener('mousedown', R, !0),
                        i.removeEventListener('touchstart', R, !0),
                        i.removeEventListener('click', $, !0),
                        i.removeEventListener('keydown', z, !0),
                        u
                    );
            },
            q = function (l) {
                var a = l.some(function (v) {
                    var S = Array.from(v.removedNodes);
        ...
        return (
            (u = {
                ...
                activate: function (l) {
                    ...
                    var a = d(l, 'onActivate'),
                        v = d(l, 'onPostActivate'),
                        S = d(l, 'checkCanFocusTrap');
                    S || m(),
                        (o.active = !0),
                        (o.paused = !1),
                    ...
                    return S
                        ? (S(o.containers.concat()).then(T, T), this)
                        : (T(), this);
                },
                deactivate: function (l) {
                    ...
                    clearTimeout(o.delayInitialFocusTimer),
                        ...
                        (o.paused = !1),
                        J(),
                        Pr.deactivateTrap(n, u);
                    var v = d(a, 'onDeactivate'),
                        S = d(a, 'onPostDeactivate'),
                        T = d(a, 'checkCanReturnFocus'),
                        D = d(a, 'returnFocus', 'returnFocusOnDeactivate');
                    v?.();
                    var C = function () {
                        Fr(function () {
                            D && I(M(o.nodeFocusedBeforeActivation)), S?.();
                        });
                    };
                    return D && T
                        ? (T(M(o.nodeFocusedBeforeActivation)).then(C, C), this)
                        : (C(), this);
                },
                pause: function (l) {
                    ...
                    var a = d(l, 'onPause'),
                        v = d(l, 'onPostPause');
                    return (o.paused = !0), a?.(), X(), J(), v?.(), this;
                },
                unpause: function (l) {
                    if (!o.paused || !o.active) return this;
                    var a = d(l, 'onUnpause'),
                        v = d(l, 'onPostUnpause');
                    return (o.paused = !1), a?.(), m(), B(), J(), v?.(), this;
                },
                updateContainerElements: function (l) {
                    var a = [].concat(l).filter(Boolean);
                    return (
                        (o.containers = a.map(function (v) {
...
var kt = (e, t, r) => Math.min(Math.max(r, e), t);
var V = { duration: 0.3, delay: 0, endDelay: 0, repeat: 0, easing: 'ease' };
var Q = e => typeof e == 'number';
var lt = e => Array.isArray(e) && !Q(e[0]);
var Mr = (e, t, r) => {
    let i = t - e;
    return ((((r - e) % i) + i) % i) + e;
};
function zt(e, t) {
    return lt(e) ? e[Mr(0, e.length, t)] : e;
}
var Tt = (e, t, r) => -r * e + r * t + e;
var jt = () => {},
    Z = e => e;
...
function $t(e, t = At(e.length), r = Z) {
    let i = e.length,
        n = i - t.length;
    return (
        n > 0 && Pt(t, n),
        s => {
            let o = 0;
            for (; o < i - 2 && !(s < t[o + 1]); o++);
            let u = kt(0, 1, ot(t[o], t[o + 1], s));
            return (u = zt(r, o)(u)), Tt(e[o], e[o + 1], u);
        }
    );
}
var Wt = e => Array.isArray(e) && Q(e[0]);
var gt = e => typeof e == 'object' && !!e.createAnimation;
var G = e => typeof e == 'function';
var ut = e => typeof e == 'string';
var yt = { ms: e => e * 1e3, s: e => e / 1e3 };
function je(e, t) {
    return t ? e * (1e3 / t) : 0;
}
var kr = (e, t, r) =>
...
function wn(e, t, r, i, n) {
    let s,
        o,
        u = 0;
    do (o = t + (r - t) / 2), (s = kr(o, i, n) - e), s > 0 ? (r = o) : (t = o);
    while (Math.abs(s) > yn && ++u < bn);
    return o;
}
function It(e, t, r, i) {
    if (e === t && r === i) return Z;
    let n = s => wn(s, 0, 1, e, r);
    return s => (s === 0 || s === 1 ? s : kr(n(s), t, i));
}
var $e =
    (e, t = 'end') =>
    r => {
...
var zr = {
        ease: It(0.25, 0.1, 0.25, 1),
        'ease-in': It(0.42, 0, 1, 1),
        'ease-in-out': It(0.42, 0, 0.58, 1),
        'ease-out': It(0, 0, 0.58, 1),
    },
    En = /\((.*?)\)/;
function Ft(e) {
    if (G(e)) return e;
    ...
    if (e.startsWith('steps')) {
        ...
        if (t) {
            let r = t[1].split(',');
            return $e(parseFloat(r[0]), r[1].trim());
        }
    }
    return Z;
}
var ft = class {
    constructor(
        ...
        if (
            ...
            let m = i.createAnimation(r);
            (i = m.easing), (r = m.keyframes || r), (n = m.duration || n);
        }
        (this.repeat = u),
            (this.easing = lt(i) ? Z : Ft(i)),
            this.updateDuration(n);
        let g = $t(r, d, lt(i) ? i.map(Ft) : Z);
        (this.tick = m => {
            var L;
            s = s;
            let I = 0;
            ...
            (f === 'reverse' ||
                (f === 'alternate' && P) ||
                (f === 'alternate-reverse' && !P)) &&
                (R = 1 - R);
            let F = I >= this.totalDuration ? 1 : Math.min(R, 1),
                z = g(this.easing(F));
            t(z),
                this.pauseTime === void 0 &&
...
function he(e) {
    return (
        We.has(e) || We.set(e, { transforms: [], values: new Map() }), We.get(e)
    );
}
function jr(e, t) {
    return e.has(t) || e.set(t, new Bt()), e.get(t);
}
var xn = ['', 'X', 'Y', 'Z'],
    Sn = ['translate', 'scale', 'rotate', 'skew'],
    Ht = { x: 'translateX', y: 'translateY', z: 'translateZ' },
    $r = {
        syntax: '<angle>',
        initialValue: '0deg',
...
Sn.forEach(e => {
    xn.forEach(t => {
        pe.push(e + t), bt.set(me(e + t), On[e]);
    });
});
var Tn = (e, t) => pe.indexOf(e) - pe.indexOf(t),
    An = new Set(pe),
    ve = e => An.has(e),
    Wr = (e, t) => {
        Ht[t] && (t = Ht[t]);
        let { transforms: r } = he(e);
        ke(r, t), (e.style.transform = In(r));
    },
    In = e => e.sort(Tn).reduce(_n, '').trim(),
    _n = (e, t) => `${e} ${t}(var(${me(t)}))`;
var Kt = e => e.startsWith('--'),
    Vr = new Set();
function Br(e) {
    if (!Vr.has(e)) {
        Vr.add(e);
        try {
            let { syntax: t, initialValue: r } = bt.has(e) ? bt.get(e) : {};
...
var Ve = (e, t) => document.createElement('div').animate(e, t),
    Hr = {
        cssRegisterProperty: () =>
            typeof CSS < 'u' &&
        ...
        finished: () => !!Ve({ opacity: [0, 1] }, { duration: 0.001 }).finished,
        linearEasing: () => {
            try {
                Ve({ opacity: 0 }, { easing: 'linear(0, 1)' });
            } catch {
                return !1;
            }
            return !0;
    ...
    Be = {},
    wt = {};
for (let e in Hr) wt[e] = () => (Be[e] === void 0 && (Be[e] = Hr[e]()), Be[e]);
var Nn = 0.015,
    Dn = (e, t) => {
        let r = '',
            i = Math.round(t / Nn);
        for (let n = 0; n < i; n++) r += e(ot(0, i - 1, n)) + ', ';
    ...
    He = (e, t) =>
        G(e)
            ...
            ? Pn(e)
            : e,
    Pn = ([e, t, r, i]) => `cubic-bezier(${e}, ${t}, ${r}, ${i})`;
function Kr(e, t) {
...
function Ut(e) {
    return Ht[e] && (e = Ht[e]), ve(e) ? me(e) : e;
}
var qt = {
    get: (e, t) => {
        t = Ut(t);
        let r = Kt(t) ? e.style.getPropertyValue(t) : getComputedStyle(e)[t];
        if (!r && r !== 0) {
            let i = bt.get(t);
            i && (r = i.initialValue);
        }
    ...
    set: (e, t, r) => {
        (t = Ut(t)), Kt(t) ? e.style.setProperty(t, r) : (e.style[t] = r);
    },
};
function ye(e, t = !0) {
...
function be(e, t, r, i = {}, n) {
    ...
    let $ = Ut(t),
        ...
        X = bt.get($);
    return (
        ye(B.animation, !(gt(m) && B.generator) && i.record !== !1),
        () => {
            let q = () => {
                    var b, l;
                    return (l =
                        (b = qt.get(e, $)) !== null && b !== void 0
                            ? b
                            : X?.initialValue) !== null && l !== void 0
                        ? l
                        : 0;
                },
                _ = Kr(ge(r), q),
                J = Ur(_, X);
            if (gt(m)) {
                let b = m.createAnimation(_, t !== 'opacity', q, $, B);
                (m = b.easing), (_ = b.keyframes || _), (d = b.duration || d);
            }
            if (
                (Kt($) && (wt.cssRegisterProperty() ? Br($) : (z = !1)),
                F &&
                    !wt.linearEasing() &&
                    (G(m) || (lt(m) && m.some(G))) &&
                    (z = !1),
                ...
                X && (_ = _.map(a => (Q(a) ? X.toDefaultUnit(a) : a))),
                    _.length === 1 &&
                        (!wt.partialKeyframes() || o) &&
                        _.unshift(q());
                let b = {
                    delay: yt.ms(f),
                    duration: yt.ms(d),
                    endDelay: yt.ms(y),
                    easing: lt(m) ? void 0 : He(m, d),
                    direction: I,
                    iterations: g + 1,
                    fill: 'both',
                };
                (u = e.animate(
                    {
                        [$]: _,
                        offset: M,
                        easing: lt(m) ? m.map(a => He(a, d)) : void 0,
                    },
                    b
                )),
                    u.finished ||
                        (u.finished = new Promise((a, v) => {
                            (u.onfinish = a), (u.oncancel = v);
                        }));
                let l = _[_.length - 1];
                u.finished
                    .then(() => {
                        L || (qt.set(e, $, l), u.cancel());
                    })
                    .catch(jt),
                    k || (u.playbackRate = 1.000001);
            } else if (n && F)
                (_ = _.map(b => (typeof b == 'string' ? parseFloat(b) : b))),
                    _.length === 1 && _.unshift(parseFloat(q())),
                    (u = new n(
                        b => {
                            qt.set(e, $, J ? J(b) : b);
                        },
                ...
                let b = _[_.length - 1];
                qt.set(e, $, X && Q(b) ? X.toDefaultUnit(b) : b);
            }
            return (
                o &&
                    s(
...
var Ln = e => e(),
    _t = (e, t, r = V.duration) =>
        new Proxy(
            { animations: e.map(Ln).filter(Boolean), duration: r, options: t },
            Rn
        ),
    Cn = e => e.animations[0],
    Rn = {
    ...
    Mn = e => e.finished;
function qr(e = 0.1, { start: t = 0, from: r = 0, easing: i } = {}) {
    return (n, s) => {
        let o = Q(r) ? r : kn(r, s),
            u = Math.abs(o - n),
            d = e * u;
...
function Gr(e) {
    return function (r, i, n = {}) {
        r = Et(r);
        let s = r.length;
        Vt(!!s, 'No valid element provided.'), Vt(!!i, 'No keyframes defined.');
        let o = [];
        for (let u = 0; u < s; u++) {
            let d = r[u];
            for (let f in i) {
                let y = we(n, f);
                y.delay = Ee(y.delay, u, s);
                let g = be(d, f, i[f], y, e);
                o.push(g);
            }
        }
...
function zn(e, t, r) {
    for (let i = 0; i < e.length; i++) {
        let n = e[i];
        n.at > t && n.at < r && (ze(e, n), i--);
    }
}
function Zr(e, t, r, i, n, s) {
    zn(e, n, s);
    for (let o = 0; o < t.length; o++)
        e.push({ value: t[o], at: Tt(n, s, i[o]), easing: zt(r, o) });
}
function Xr(e, t) {
...
function Yr(e, t = {}) {
    var r;
    let i = jn(e, t),
        n = i.map(s => be(...s, ft)).filter(Boolean);
    return _t(
        n,
        t,
...
function jn(e, t = {}) {
    ...
    for (let g = 0; g < e.length; g++) {
        ...
        if (ut(m)) {
            ...
            u.set(m.name, Ue(f, m.at, d, u));
            continue;
        }
        let [L, I, M = {}] = m;
        M.at !== void 0 && (f = Ue(f, M.at, d, u));
        let k = 0,
            R = Et(L, o),
            P = R.length;
        for (let F = 0; F < P; F++) {
            ...
            for (let B in I) {
                let X = Wn(B, $),
                    ...
                    _ = we(M, B),
                    {
                        duration: J = r.duration || V.duration,
                        easing: b = r.easing || V.easing,
                    } = _;
                if (gt(b)) {
                    Vt(
                        B === 'opacity' || q.length > 1,
                        'spring must be provided 2 keyframes within timeline()'
                    );
                    let D = b.createAnimation(q, B !== 'opacity', () => 0, B);
                    (b = D.easing),
                        (q = D.keyframes || q),
                        (J = D.duration || J);
                }
                let l = Ee(M.delay, F, P) || 0,
                    a = f + l,
                    v = a + J,
                    { offset: S = At(q.length) } = _;
                S.length === 1 && S[0] === 0 && (S[1] = 1);
                let T = S.length - q.length;
                T > 0 && Pt(S, T),
                    q.length === 1 && q.unshift(null),
                    Zr(X, q, b, S, a, v),
                    (k = Math.max(l + J, k)),
                    (y = Math.max(v, y));
            }
        ...
        s.forEach((g, m) => {
            for (let L in g) {
                ...
                for (let P = 0; P < I.length; P++) {
                    let { at: F, value: z, easing: $ } = I[P];
                    M.push(z), k.push(ot(0, y, F)), R.push($ || V.easing);
                }
                k[0] !== 0 &&
                    (k.unshift(0), M.unshift(M[0]), R.unshift('linear')),
                    k[k.length - 1] !== 1 && (k.push(1), M.push(null)),
                    n.push([
                        m,
                        L,
                        M,
...
var Vn = { any: 0, all: 1 };
function Qr(e, t, { root: r, margin: i, amount: n = 'any' } = {}) {
    ...
    let s = Et(e),
        ...
        u = f => {
            f.forEach(y => {
                ...
                if (y.isIntersecting !== !!g)
                    if (y.isIntersecting) {
                        let m = t(y);
                        G(m) ? o.set(y.target, m) : d.unobserve(y.target);
        ...
        d = new IntersectionObserver(u, {
            root: r,
            rootMargin: i,
            threshold: typeof n == 'number' ? n : Vn[n],
        });
    return s.forEach(f => d.observe(f)), () => d.disconnect();
}
var Se = new WeakMap(),
    xt;
function Bn(e, t) {
...
function Un() {
    typeof ResizeObserver > 'u' || (xt = new ResizeObserver(Kn));
}
function Jr(e, t) {
    xt || Un();
    let r = Et(e);
    return (
        r.forEach(i => {
            let n = Se.get(i);
            n || ((n = new Set()), Se.set(i, n)), n.add(t), xt?.observe(i);
        }),
        () => {
            r.forEach(i => {
                let n = Se.get(i);
                n?.delete(t), n?.size || xt?.unobserve(i);
            });
        }
    );
}
...
function ti(e) {
    return (
        ...
        Gt || qn(),
        () => {
            Oe.delete(e), !Oe.size && Gt && (Gt = void 0);
        }
    );
}
function ei(e, t) {
    return G(e) ? ti(e) : Jr(e, t);
}
var Gn = 50,
    ri = () => ({
        current: 0,
...
function ii(e, t, r, i) {
    ...
    (n.current = e['scroll' + o]),
        ...
        (n.progress = ot(0, n.scrollLength, n.current));
    let f = i - d;
    n.velocity = f > Gn ? 0 : je(n.current - u, f);
}
function oi(e, t, r) {
    ii(e, 'x', t, r), ii(e, 'y', t, r), (t.time = r);
}
function si(e, t) {
    let r = { x: 0, y: 0 },
        i = e;
    for (; i && i !== t; )
        if (i instanceof HTMLElement)
            ...
            for (r.x += s, r.y += n; i && i.tagName !== 'svg'; )
                i = i.parentNode;
        }
    return r;
}
...
var Ae = { start: 0, center: 0.5, end: 1 };
function qe(e, t, r = 0) {
    let i = 0;
    if ((Ae[e] !== void 0 && (e = Ae[e]), ut(e))) {
        let n = parseFloat(e);
        e.endsWith('px')
            ? (i = n)
            : e.endsWith('%')
...
function li(e, t, r) {
    ...
    t[s].offset.length = 0;
    let y = !t[s].interpolate,
        g = i.length;
    for (let m = 0; m < g; m++) {
        let L = ai(i[m], f[o], d[o], u[s]);
        !y && L !== t[s].interpolatorOffsets[m] && (y = !0),
            (t[s].offset[m] = L);
    }
    y &&
        ((t[s].interpolate = $t(At(g), t[s].offset)),
...
function ci(e, t, r, i = {}) {
    let n = i.axis || 'y';
    return {
        measure: () => Qn(e, i.target, r),
        update: s => {
            oi(e, r, s), (i.offset || i.target) && li(e, r, i);
        },
        notify: G(t) ? () => t(r) : Jn(t, r[n]),
    };
}
function Jn(e, t) {
    return (
        ...
        e.forEachNative((r, { easing: i }) => {
            var n, s;
            if (r.updateDuration) i || (r.easing = Z), r.updateDuration(1);
            else {
                let o = { duration: 1e3 };
                i || (o.easing = 'linear'),
                    (s =
...
var Zt = new WeakMap(),
    ui = new WeakMap(),
    Ge = new WeakMap(),
    fi = e => (e === document.documentElement ? window : e);
function di(e, t = {}) {
    var { container: r = document.documentElement } = t,
        i = xe(t, ['container']);
    let n = Ge.get(r);
    n || ((n = new Set()), Ge.set(r, n));
    let s = ni(),
        o = ci(r, e, s, i);
    if ((n.add(o), !Zt.has(r))) {
        let f = () => {
            let g = performance.now();
            for (let m of n) m.measure();
            for (let m of n) m.update(g);
            for (let m of n) m.notify();
        };
        Zt.set(r, f);
        let y = fi(r);
        window.addEventListener('resize', f, { passive: !0 }),
            r !== document.documentElement && ui.set(r, ei(r, f)),
    ...
    return () => {
        var f;
        typeof e != 'function' && e.stop(), cancelAnimationFrame(d);
        let y = Ge.get(r);
        if (!y || (y.delete(o), y.size)) return;
        let g = Zt.get(r);
        Zt.delete(r),
            g &&
                (fi(r).removeEventListener('scroll', g),
                (f = ui.get(r)) === null || f === void 0 || f(),
...
dt.prototype.on = function (e, t, r, i) {
    ...
    return (
        ...
        t
            ...
            : ((u = null), (o = ro.bind(this))),
        s[e].push({ selector: t, handler: r, matcher: o, matcherParam: u }),
        this
    );
};
dt.prototype.off = function (e, t, r, i) {
    ...
    if (((o = this.listenerMap[i ? 1 : 0]), !e)) {
        for (d in o) o.hasOwnProperty(d) && this.off(d, t, r);
        return this;
    }
    ...
    for (n = u.length - 1; n >= 0; n--)
        (s = u[n]),
            (!t || t === s.selector) &&
                (!r || r === s.handler) &&
                (this._removedListeners.push(s), u.splice(n, 1));
    return (
        u.length ||
            (delete o[e],
            this.rootElement &&
...
dt.prototype.handle = function (e) {
    ...
    switch (
        ...
        case 1:
            d = this.listenerMap[1][i];
            break;
        case 2:
            this.listenerMap[0] &&
                this.listenerMap[0][i] &&
                (d = d.concat(this.listenerMap[0][i])),
                this.listenerMap[1] &&
                    this.listenerMap[1][i] &&
                    (d = d.concat(this.listenerMap[1][i]));
            break;
        case 3:
            d = this.listenerMap[0][i];
            break;
    }
    let g = [];
    for (r = d.length; f && r; ) {
        for (t = 0; t < r && ((o = d[t]), !!o); t++)
            f.tagName &&
            ...
            f.hasAttribute('disabled')
                ? (g = [])
                : o.matcher.call(f, o.matcherParam, f) && g.push([e, f, o]);
        if (
            f === n ||
            ((r = d.length),
    ...
    for (t = 0; t < g.length; t++)
        if (
            !(this._removedListeners.indexOf(g[t][2]) > -1) &&
            ((u = this.fire.apply(this, g[t])), u === !1)
        ) {
            (g[t][0][y] = !0), g[t][0].preventDefault(), (m = !1);
            break;
        }
    return m;
};
...
var Xe = class {
        ...
        addFilter(t, r, i = 100) {
            ...
            this._filters[t] || (this._filters[t] = []),
                ...
                (s = this._filters[t]) === null ||
                    s === void 0 ||
                    s.sort((u, d) => u.priority - d.priority),
                (o = this.pswp) === null ||
                    o === void 0 ||
                    o.addFilter(t, r, i);
        }
        ...
        setDisplayedSize(t, r) {
            this.element &&
                (this.element.tagName === 'IMG'
                    ? (Ze(this.element, 250, 'auto'),
                      (this.element.style.transformOrigin = '0 0'),
                      (this.element.style.transform = oo(0, 0, t / 250)))
                    : Ze(this.element, t, r));
        }
        destroy() {
            var t;
    ...
    Je = class {
        ...
        load(t, r) {
            if (this.slide && this.usePlaceholder())
                if (this.placeholder) {
                    ...
                    this.placeholder = new Qe(i, this.slide.container);
                }
            (this.element && !r) ||
                ...
                (this.isImageContent()
                    ? ((this.element = Xt('pswp__img', 'img')),
                      this.displayedImageWidth && this.loadImage(t))
                    : ((this.element = Xt('pswp__content', 'div')),
        ...
        append() {
            ...
            this.isImageContent()
                ? t && this.slide && (!this.slide.isActive || pi())
                    ? ((this.isDecoding = !0),
                      this.element
                          .decode()
                          .catch(() => {})
        ...
        activate() {
            this.instance.dispatch('contentActivate', { content: this })
                .defaultPrevented ||
                !this.slide ||
                (this.isImageContent() && this.isDecoding && !pi()
                    ? this.appendImage()
...
function co(e, t, r, i) {
    return {
        x: t.x - Ie('left', e, t, r, i) - Ie('right', e, t, r, i),
        y: t.y - Ie('top', e, t, r, i) - Ie('bottom', e, t, r, i),
    };
}
var mi = 4e3,
    tr = class {
        ...
        _getSecondary() {
            ...
            return (
                ...
                this.elementSize &&
                    t * this.elementSize.x > mi &&
                    (t = mi / this.elementSize.x),
                t)
            );
        }
        _getInitial() {
...
function vi(e, t, r) {
    ...
    if (s) {
        n = new tr(s, e, -1);
        let o;
        t.pswp ? (o = t.pswp.viewportSize) : (o = lo(s, t));
        let u = co(s, o, e, r);
...
var er = class extends Ye {
        ...
        _getGalleryDOMElements(t) {
            var r, i;
            return ((r = this.options) !== null &&
                r !== void 0 &&
                r.children) ||
                ((i = this.options) !== null && i !== void 0 && i.childSelector)
                ? Yt(this.options.children, this.options.childSelector, t) || []
                : [t];
        }
            ...
            if (i) {
                ...
                if (s) {
                    ...
                    (r.msrc = s.currentSrc || s.src),
                        (r.alt =
                            (n = s.getAttribute('alt')) !== null && n !== void 0
                                ? n
                                : '');
                }
    ...
    rr = class extends er {
        ...
        init() {
            Yt(this.options.gallery, this.options.gallerySelector).forEach(
                t => {
        ...
        preload(t, r) {
            ...
            if (ao(i.pswpModule)) n.push(Promise.resolve(i.pswpModule));
            else {
                if (s === 'string')
                    throw new Error(
            ...
            typeof i.openPromise == 'function' && n.push(i.openPromise()),
                i.preloadFirstSlide !== !1 &&
                    t >= 0 &&
                    (this._preloadedContent = uo(t, this));
            let o = ++this._uid;
